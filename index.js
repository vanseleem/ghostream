...
const SOURCE_CONFIG = [
  ...
  { name: '1337x', display: '1337x', order: 2 },
  { name: 'rutor', display: 'Rutor', order: 3 },
  { name: 'nyaasi', display: 'Nyaa', order: 4 },
  { name: 'torrentgalaxy', display: 'TGx', order: 5 },
  { name: 'eztv', display: 'EZTV', order: 6 },
  { name: 'thepiratebay', display: 'TPB', order: 7 },
  { name: 'piratebay', display: 'TPB', order: 7 },
  { name: 'the piratebay', display: 'TPB', order: 7 },
  { name: 'tpb', display: 'TPB', order: 7 },
  { name: 'rutracker', display: 'Rutracker', order: 8 },
  { name: 'rarbg', display: 'RARBG', order: 9 }
];
...
function sortAndGroup(streams) {
  ...
  sortedQualities.forEach(quality => {
    const topLinks = byQuality[quality].slice(0, LINKS_PER_QUALITY);
